...
set :application_name, 'rondon-pe'
set :domain, '104.236.111.9'
set :deploy_to, '/var/www/rondon-pe'
set :repository, 'git@bitbucket.org:hiagoserpa/rondon-pe.git'
set :branch, 'master'

# Optional settings:
   set :user, 'hiago'          # Username in the server to SSH to.
